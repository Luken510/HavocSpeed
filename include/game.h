...
namespace GAME {
	...
	private:
		...
		std::shared_ptr<UTIL::CAMERA::CameraBase> m_standardCamera = std::make_shared<UTIL::CAMERA::BasicCamera>(WIN_WIDTH,WIN_HEIGHT);
		std::shared_ptr<UTIL::CAMERA::CameraBase> m_rearViewCamera = std::make_shared<UTIL::CAMERA::RearCamera>(WIN_WIDTH, WIN_HEIGHT);
		std::shared_ptr<UTIL::CAMERA::CameraBase> m_firstPersonCamera = std::make_shared<UTIL::CAMERA::firstPersonCamera>(WIN_WIDTH, WIN_HEIGHT);
